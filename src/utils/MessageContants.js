...
export const PHONE = {
  ...
  NO_PHONE: 'Số điện thoại chưa được nhập !',
};
...
export const NOTIFY = {
  ...
  DATE: 'Không được nhập quá ngày hiện tại !',
};
export const ON_SUCCESS = 'Thao tác thành công!';
export const ON_FAIL = 'Thao tác thất bại!';
