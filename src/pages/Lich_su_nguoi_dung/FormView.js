    ...
    >
      ...
      >
        <Grid>
          ...
          >
            <Grid item sx={6}>
              <CustomTextField label="Ứng Dụng Ký" />
            </Grid>
            <Grid item sx={6}>
              <CustomTextField label="Người dùng" />
            </Grid>
          </Grid>
          <Grid
            container
          ...
          >
            <Grid item sx={6}>
              <CustomTextField label="Thời gian tạo" />
            </Grid>
            <Grid item sx={6}>
          ...
          >
            <Grid item sx={6}>
              <CustomTextField label="Tài liệu" />
            </Grid>
            <Grid item sx={6}>
              <CustomTextField label="Trạng thái ký" />
            </Grid>
          </Grid>
          <Grid
            container
          ...
          >
            <Grid item sx={6}>
              <CustomTextField label="IDchữ ký" />
            </Grid>
            <Grid item sx={6}>
              <CustomTextField label="Thời gian ký" />
            </Grid>
          </Grid>
        </Grid>
      </DialogContent>
